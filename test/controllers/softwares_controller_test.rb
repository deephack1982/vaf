...
class SoftwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post softwares_url, params: { software: { name: @software.name, required: @software.required } }
    end
  ...
  test "should update software" do
    patch software_url(@software), params: { software: { name: @software.name, required: @software.required } }
