...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  Pilot.create(name: 'Chuck Cumming', email: 'dotchuckles@gmail.com', rank: 'Acting Pilot Officer', squadron_id: '1', password: 'test1', password_confirmation: 'test1', admin: '1')
